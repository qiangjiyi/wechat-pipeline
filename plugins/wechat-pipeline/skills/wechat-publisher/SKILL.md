...
把已经完成的图片卡片或已排版文章推送到微信公众号草稿箱，不做正式群发。流水线模式要求 `protocol_version: 2026-07-18-001`。
...
5. 流水线模式先运行 `${PIPELINE_ROOT}/scripts/build_publish_snapshot.py <run-dir> --validate`，只接受 canonical `.pipeline/publish-snapshot.json`。
